...
# Luca API Feature
# -----------------------------------------------------------------------------
# Luca is an AI assistant powered by Google ADK and Gemini.
# Deployed as a FastAPI application on Cloud Run.
# -----------------------------------------------------------------------------
...
# - Cloud Run service via ai_feature_example module
# - GitHub CI/CD service account with appropriate permissions
# -----------------------------------------------------------------------------
